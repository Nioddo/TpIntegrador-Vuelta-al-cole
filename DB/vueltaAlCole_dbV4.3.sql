...
--
-- Host: 127.0.0.1    Database: db_colevueltasv2
-- ------------------------------------------------------
...
INSERT INTO `chats` VALUES (1,1,3,4,'Activo','2025-11-23 23:00:39','2025-11-23 23:00:39',NULL);
...
INSERT INTO `notificaciones` VALUES (1,2,2,NULL,NULL,NULL,'2025-11-23 23:00:39',NULL),(2,3,2,NULL,NULL,NULL,'2025-11-23 23:00:39',NULL),(3,4,2,NULL,NULL,NULL,'2025-11-23 23:00:39',NULL),(4,3,4,NULL,NULL,NULL,'2025-11-23 23:00:48',NULL);
...
INSERT INTO `publicacion` VALUES (1,4,4,'Chomba Otto Krause','Usada buen estado',5000.00,'Bueno','2025-11-23 23:00:39','2025-11-23 23:00:48','Vendido',0.00,NULL,NULL,'2025-11-23 20:00:48'),(2,2,3,'Pantalón Nacional','Casi nuevo',8000.00,'Excelente','2025-11-23 23:00:39','2025-11-23 23:00:39','Vendido',0.00,NULL,NULL,'2025-11-23 20:00:39'),(3,4,6,'Calculadora Casio','Científica fx-95',15000.00,'Muy bueno','2025-11-23 23:00:39','2025-11-23 23:00:39','Vendido',0.00,NULL,NULL,'2025-11-23 20:00:39'),(4,2,5,'Libro Matemática 1','Editorial Santillana',2000.00,'Aceptable','2025-11-23 23:00:39','2025-11-23 23:00:39','Vendido',0.00,NULL,NULL,'2025-11-23 20:00:39'),(5,2,6,'Regla Vieja','De hace un año',100.00,NULL,'2024-01-01 13:00:00','2025-11-23 23:00:39','Activo',0.00,NULL,NULL,NULL),(6,2,6,'Regla de Prueba SP','Creada por Procedure',550.00,'Nuevo','2025-11-23 23:02:49','2025-11-23 23:02:49','Activo',0.00,NULL,NULL,NULL),(7,4,3,'Pollera Test SP','Uniforme creado por SP',12000.00,'Bueno','2025-11-23 23:02:59','2025-11-23 23:02:59','Activo',0.00,NULL,NULL,NULL),(8,2,6,'Regla de Prueba SP','Creada por Procedure',550.00,'Nuevo','2025-11-23 23:04:14','2025-11-23 23:04:14','Activo',0.00,NULL,NULL,NULL),(9,4,3,'Pollera Test SP','Uniforme creado por SP',12000.00,'Bueno','2025-11-23 23:04:17','2025-11-23 23:04:17','Activo',0.00,NULL,NULL,NULL),(10,4,3,'Pollera Test SP','Uniforme creado por SP',12000.00,'Bueno','2025-11-23 23:05:13','2025-11-23 23:05:13','Activo',0.00,NULL,NULL,NULL);
...
INSERT INTO `publicacion_uniforme` VALUES (1,2,2),(2,5,1),(5,1,1),(7,2,1),(9,2,1),(10,2,1);
...
CREATE TABLE `talles` (
  `id` int NOT NULL AUTO_INCREMENT,
  `talle` varchar(50) NOT NULL COMMENT 'Ej: S, M, L, XL, 40, 42',
...
INSERT INTO `usuarios` VALUES (1,'Admin','Supremo','admin@cole.com','pass123',NULL,'2025-11-23 23:00:39','Otro',NULL,NULL,1000,5,1,NULL,0,NULL,0,NULL,1,'admin_god',NULL,NULL,NULL),(2,'Juan','Vendedor','juan@mail.com','pass123',NULL,'2025-11-23 23:00:39','Otro',NULL,NULL,100,2,0,5,1,NULL,0,NULL,0,'juan_ventas',NULL,NULL,NULL),(3,'Pedro','Comprador','pedro@mail.com','pass123',NULL,'2025-11-23 23:00:39','Otro',NULL,NULL,225,3,1,NULL,0,NULL,0,NULL,0,'comprador_compulsivo',NULL,NULL,NULL),(4,'Ana','Pro','ana@mail.com','pass123',NULL,'2025-11-23 23:00:39','Otro',NULL,NULL,124,2,1,NULL,0,NULL,0,NULL,0,'ana_uniformes',NULL,NULL,NULL),(5,'Maria','Nueva','maria@mail.com','pass123',NULL,'2025-11-23 23:00:39','Otro',NULL,NULL,25,1,0,NULL,0,NULL,0,'2025-11-23 20:10:30',0,'mary_new',NULL,NULL,NULL);
...
INSERT INTO `ventas` VALUES (1,2,NULL,3,2,8000,NULL,'2025-11-23 23:00:39'),(2,4,NULL,3,2,2000,NULL,'2025-11-23 23:00:39'),(3,2,NULL,3,4,8000,NULL,'2025-11-23 23:00:39'),(4,4,NULL,3,4,2000,NULL,'2025-11-23 23:00:39'),(100,3,NULL,5,2,15000,NULL,'2025-11-13 23:00:39'),(101,1,NULL,3,4,5000,NULL,'2025-11-23 23:00:48');
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_cerrar_publicacion_al_vender` AFTER INSERT ON `ventas` FOR EACH ROW BEGIN
    -- Marcamos la publicación como VENDIDA automáticamente
    UPDATE publicacion 
    SET estado = 'Vendido',
        fecha_eliminacion = NOW() -- Opcional: Para que deje de aparecer en búsquedas activas
    WHERE id = NEW.id_publicacion;
    
    -- Opcional: Si había un chat activo asociado a esa venta, lo pasamos a 'Vendido'
...
-- Dump completed on 2025-11-23 20:15:34
